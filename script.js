...
const playersDrawCards = () => {
    for (var i = 0; i < numberOfPlayers; i++) {
        ...
        document.querySelector('.playerCards_' + i + '_1').innerHTML = `<img src="./cards/${firstCard}.png" style="width:128px;height:153px;float:left;">`
        document.querySelector('.playerCards_' + i + '_2').innerHTML = `<img src="./cards/${secondCard}.png"style="width:128px;height:153px;float:left;margin-right:25px;">`
  }
}
